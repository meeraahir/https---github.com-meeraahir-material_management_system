...
urlpatterns = [
    ...
    path('reports/site-wise/', LabourViewSet.as_view({'get': 'site_wise_report'}), name='labour-report-site-wise'),
    path('reports/site-wise/export/', LabourViewSet.as_view({'get': 'export_site_wise_report'}), name='labour-report-site-wise-export'),
    path('reports/site-wise/pdf/', LabourViewSet.as_view({'get': 'export_site_wise_report_pdf'}), name='labour-report-site-wise-pdf'),
    path('reports/site/<int:site_id>/', LabourViewSet.as_view({'get': 'site_specific_report'}), name='labour-report-site-specific'),
    path('reports/site/<int:site_id>/export/', LabourViewSet.as_view({'get': 'export_site_specific_report'}), name='labour-report-site-specific-export'),
